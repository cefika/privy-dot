...
function configureEvm(rpcUrl, chainId = 420420421) {
  _rpcUrl = rpcUrl;
  _chainId = chainId;
  _providerInstance = new ethers.JsonRpcProvider(rpcUrl, void 0, { staticNetwork: true });
}
